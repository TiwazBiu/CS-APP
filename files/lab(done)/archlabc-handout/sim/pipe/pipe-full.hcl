...
# I implement the IIADDL and ILEAVE, every time I modify the HCL,
# I will give a comment.
...
# I also add the complement of load/use, every time I modify the HCL,
# I will give a comment.

# But I can only make it work, as for the optimization, I have done 
# nothing in HCL level, and I use a 32-way loop-unrolling to optimize.
...
int e_valA =[ 
#ileave
        M_icode in { IMRMOVL, IPOPL, ILEAVE }
        && E_icode in { IRMMOVL, IPUSHL } 
        && M_dstM == E_srcA
        && M_dstM != E_srcB  : m_valM;
        1                    : E_valA;
];
