...
0000000000400fce <func4>:
  ...
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24> //if <=, jump to ff2
  ...
  400ff9:	7d 0c                	jge    401007 <func4+0x39> //return
  400ffb:	8d 71 01             	lea    0x1(%rcx),%esi      //esi=rcx+1
  400ffe:	e8 cb ff ff ff       	callq  400fce <func4>
  401003:	8d 44 00 01          	lea    0x1(%rax,%rax,1),%eax //eax=2rax+1
...
000000000040100c <phase_4>:
  ...
  401029:	83 f8 02             	cmp    $0x2,%eax //return num of input number
  40102c:	75 07                	jne    401035 <phase_4+0x29> //if !=, bomb
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp) //*(rsp+0x8):0xe
  401033:	76 05                	jbe    40103a <phase_4+0x2e> //if <=, skip bomb
  ...
  40104d:	85 c0                	test   %eax,%eax //test return value
  40104f:	75 07                	jne    401058 <phase_4+0x4c> //if !=0, bomb
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp) //*(rsp+0xc):0
  401056:	74 05                	je     40105d <phase_4+0x51> //if == 0, success
...
0000000000401062 <phase_5>:
  ...
  401067:	48 89 fb             	mov    %rdi,%rbx //char s[6] = "flyers"
  40106a:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax //stack guard
  401071:	00 00 
  401073:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
  401078:	31 c0                	xor    %eax,%eax //eax=0
  40107a:	e8 9c 02 00 00       	callq  40131b <string_length>//rdi is parameter
  40107f:	83 f8 06             	cmp    $0x6,%eax //check it's 6 char long
...
00000000004010f4 <phase_6>:
  ...
  40110b:	49 89 e6             	mov    %rsp,%r14 //rsp array Xs
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d//r12d=0
  401114:	4c 89 ed             	mov    %r13,%rbp //rbp=r13
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax //eax=x1
  40111b:	83 e8 01             	sub    $0x1,%eax 
  40111e:	83 f8 05             	cmp    $0x5,%eax //test x-1 < 5
  401121:	76 05                	jbe    401128 <phase_6+0x34>
  401123:	e8 12 03 00 00       	callq  40143a <explode_bomb>
  401128:	41 83 c4 01          	add    $0x1,%r12d
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d
  401130:	74 21                	je     401153 <phase_6+0x5f> //r12d=6,jump to 4001153
  ...
  401174:	eb 21                	jmp    401197 <phase_6+0xa3> //jump to 401197
  ...
  401195:	74 14                	je     4011ab <phase_6+0xb7> //jump to 4011ab
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx //ecx=x1`
  40119a:	83 f9 01             	cmp    $0x1,%ecx //ecx:0x1
  40119d:	7e e4                	jle    401183 <phase_6+0x8f> //if <=,jump to 401183
...
0000000000401204 <fun7>:
  ...
  401208:	48 85 ff             	test   %rdi,%rdi //rdi == 0?
  40120b:	74 2b                	je     401238 <fun7+0x34>
  40120d:	8b 17                	mov    (%rdi),%edx //edx = *(rdi)
  40120f:	39 f2                	cmp    %esi,%edx //edx:esi
  401211:	7e 0d                	jle    401220 <fun7+0x1c>//if edx<=esi, jump
...
0000000000401242 <secret_phase>:
  ...
  401260:	3d e8 03 00 00       	cmp    $0x3e8,%eax // if eax<=0x3e8, ignore bomb
  401265:	76 05                	jbe    40126c <secret_phase+0x2a>
  401267:	e8 ce 01 00 00       	callq  40143a <explode_bomb>
  40126c:	89 de                	mov    %ebx,%esi // esi = ebx
  40126e:	bf f0 30 60 00       	mov    $0x6030f0,%edi //edi = 0x6030f0
  401273:	e8 8c ff ff ff       	callq  401204 <fun7>
  401278:	83 f8 02             	cmp    $0x2,%eax //eax must equal to 2
